...
#F7931E"
    ...
    return (
      <div className="allrestaurants">
        ...
        <div className="contentbox">
          ...
          <p className="p1 z1 place">{location}</p>
          <div className="ratingcontainer">
            <div className="d1">
              <p className="p1 z1">{ratings}</p>
              <p className="p1 z1 bottom">{reviewCount} Rating</p>
            </div>
            <hr className="line" />
            <div className="d2 z1">
              <p className="p1 z1">Rs.{costForTwo}</p>
              <p className="p1 z1 bottom">Cost for two</p>
            </div>
          </div>
        </div>
      </div>
  ...
  displayitems = () => {
    ...
    return (
      <div className="allrestauranting">
        <ul className="restaurantunorder fooddet">
          {food.map(object => (
            <FoodDetails
              key={object.id}
